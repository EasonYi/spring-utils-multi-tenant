...
/**
 * Basic implementation of the {@code ContextRepository} uses a request
 * parameter to determine the context to use. This is not the best
 * implementation nor the wisest it merely servers as an example!
 * 
 * 
...
public class RequestParameterContextRepository implements ContextRepository {
	...
	public RequestParameterContextRepository(String parameter,
	...
	public String getContext(HttpServletRequest request,
		...
		return ServletRequestUtils.getStringParameter(request, parameter,
				defaultContext);
	}
}
